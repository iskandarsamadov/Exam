...
import person1 from './assets/Image-1-1.svg'
import person2 from './assets/Image-2-1.svg'
import person3 from './assets/Image-3-1.svg'
import person4 from './assets/Image-4-1.svg'
...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-5 flex justify-between items-center">
          ...
          <nav className="flex gap-8 items-center">
            ...
            <button className="px-6 py-2 bg-orange-500 text-white rounded-full font-semibold hover:bg-orange-600 transition cursor-pointer">{t.cloneProject}</button>
          </nav>
        </div>
      </header>
      ...
      <main>
        {/* Hero */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl lg:text-6xl font-extrabold text-[#1D3444] leading-tight mb-6 max-w-xl">We value human, organizational, and operational intelligence, not just artificial</h1>
            <p className="text-gray-600 mb-8 max-w-md">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam leo odio, sagittis quis ornare quis.</p>

            <button className="px-8 py-3 bg-orange-500 text-white rounded-full font-semibold hover:bg-orange-600 transition shadow-md">Work With Us</button>
          </div>
              <img src={HeaderImage} alt="Professional" className="w-[674px] h-[699px] object-cover rounded-2xl" />
              {/* circular stamp: larger and positioned overlapping top-right */}
                <defs>
                  <path id="stampPath2" d="M70,10 a60,60 0 1,1 0,120 a60,60 0 1,1 0,-120" />
                </defs>
                <circle cx="70" cy="70" r="62" stroke="#F59E0B" strokeWidth="6" fill="transparent" />
                
        </section>

        {/* Experience + Stats: left vertical stats, right big circle */}
        <section className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mb-6">
              <div className="pr-6">
                <h2 className="text-3xl md:text-4xl lg:text-4xl font-extrabold text-[#1D3444] leading-tight">The energy of a start-up combined with 30 years of experience</h2>
              </div>

              <div className="pl-6 flex items-start">
                <p className="text-gray-600 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sit amet eros blandit, hendrerit elit et, mattis purus. Vivamus commodo suscipit tellus et pellentesque.</p>
              </div>
            </div>
            ...
            <div className="mt-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  <div className="text-4xl md:text-5xl font-extrabold text-orange-500">15+</div>
                  <div className="font-semibold mt-2 text-gray-900">Awards received</div>
                  <div className="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscin. Curabitur sit amet eros elit et.</div>
                </div>

                <div>
                  <div className="text-4xl md:text-5xl font-extrabold text-orange-500">500+</div>
                  <div className="font-semibold mt-2 text-gray-900">Clients served</div>
                  <div className="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscin. Curabitur sit amet eros elit et.</div>
                </div>

                <div>
                  <div className="text-4xl md:text-5xl font-extrabold text-orange-500">34</div>
                  <div className="font-semibold mt-2 text-gray-900">Employees</div>
                  <div className="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscin. Curabitur sit amet eros elit et.</div>
                </div>

                <div>
                  <div className="text-4xl md:text-5xl font-extrabold text-orange-500">130+</div>
                  <div className="font-semibold mt-2 text-gray-900">Custom solutions</div>
                  <div className="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscin. Curabitur sit amet eros elit et.</div>
                </div>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl sm:text-5xl md:text-4xl font-extrabold text-[#0f1724] leading-tight mb-6 max-w-xl">We want to get local identification in every <br /> corner of the world in this <br /> era of global citizenship.</h2>
              <p className="text-gray-600 mb-8 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Curabitur sit amet eros blandit, hendrerit elit et, mattis <br /> purus. Vivamus commodo suscipit tellus et <br /> pellentesque.</p>
            </div>

            <div className="relative w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[560px]">
                <img src={AboutImage1} alt="Team working" className="w-[652px] h-[699px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>
          </div>
        </section>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#0f1724] leading-tight mb-6">Teamwork is the only <br /> way we work</h2>
            <p className="text-gray-600 mb-10 max-w-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sit amet eros <br /> blandit, hendrerit elit et, mattis purus. Vivamus commodo suscipit tellus et <br /> pellentesque.</p>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src={person1} alt="Team member 1" className="w-[290px] h-[521px] object-cover" />
              </div>

              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src={person2} alt="Team member 2" className="w-[290px] h-[521px] object-cover" />
              </div>

              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src={person3} alt="Team member 3" className="w-[289px] h-[521px] object-cover" />
              </div>

              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <img src={person4} alt="Team member 4" className="w-[290px] h-[521px] object-cover" />
              </div>
            </div>
          </div>
        </section>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#0f1724] leading-tight mb-6">Finsweet Was A Dream To Work With</h2>
              <p className="text-gray-600 mb-8 max-w-lg">Maecenas efficitur scelerisque lorem, et varius lacus <br /> tincidunt vel. Pellentesque a arcu vitae diam dapibus mattis <br /> vel vel orci. Vivamus eleifend nec felis vel auctor.</p>

              <div className="flex items-center gap-4 mt-6">
                <img src={Avatar4} alt="Chikelu Neo" className="w-14 h-14 rounded-full object-cover" />
                <div>
                  <div className="text-lg font-semibold text-[#0f1724]">Chikelu Neo</div>
                  <div className="text-sm text-orange-500">CEO at MazeAI</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[560px]">
                <img src={VideoThumb} alt="Video thumbnail" className="w-full h-[420px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>
          </div>
        </section>
