      ...
      <main>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl lg:text-6xl font-extrabold text-[#1D3444] leading-tight mb-6 max-w-xl">We serve clients with ground breaking solutions</h1>
              ...
              <button className="px-6 py-3 bg-orange-500 text-white rounded-full font-semibold hover:bg-orange-600 transition">Work With Us</button>
            </div>

            <div className="relative w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[560px]">
                <img src={HeaderImage2} alt="Services" className="w-[674px] h-[650px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative w-full flex justify-center lg:justify-start">
              <div className="relative w-full max-w-[560px]">
                <img src={Feature1} alt="Business" className="w-[668px] h-[550px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>

            <div>
              <h2 className="text-4xl font-extrabold text-[#0f1724] mb-6">Business strategy</h2>
              <p className="text-gray-600 mb-6 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Aliquam leo odio, sagittis quis ornare quis.met, consectetur <br /> adipiscing elit. Aliquam leo odio, sagittis quis ornare quis.</p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative w-full flex justify-center lg:justify-start">
              <div className="relative w-full max-w-[560px]">
                <img src={Feature3} alt="Risk" className="w-[668px] h-[550px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>

            <div>
              <h2 className="text-4xl font-extrabold text-[#0f1724] mb-6">Risk assessment</h2>
              <p className="text-gray-600 mb-6 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Aliquam leo odio, sagittis quis ornare quis.met, consectetur <br /> adipiscing elit. Aliquam leo odio, sagittis quis ornare quis.</p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-extrabold text-[#0f1724] mb-6">Artificial intelligence</h2>
              <p className="text-gray-600 mb-6 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Aliquam leo odio, sagittis quis ornare quis.met, consectetur <br /> adipiscing elit. Aliquam leo odio, sagittis quis ornare quis. <br /> Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Aliquam leo odio, sagittis.</p>
            </div>

            <div className="relative w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[560px]">
                <img src={Feature4} alt="Artificial intelligence" className="w-[668px] h-[550px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>
          </div>
        </section>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative w-full flex justify-center lg:justify-start">
              <div className="relative w-full max-w-[560px]">
                <img src={Feature5} alt="Smart Contracts" className="w-[668px] h-[550px] object-cover rounded-2xl shadow-lg" />
              </div>
            </div>

            <div>
              <h2 className="text-4xl font-extrabold text-[#0f1724] mb-6">Smart Contracts</h2>
              <p className="text-gray-600 mb-6 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Aliquam leo odio, sagittis quis ornare quis.met, consectetur <br /> adipiscing elit. Aliquam leo odio, sagittis quis ornare quis.</p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#0f1724] leading-tight mb-6 max-w-xl">Finsweet Was A Dream To Work With</h2>
